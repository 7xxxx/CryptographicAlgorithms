...
/**
 * Teste die Berechnung der Multiplikativen Inversen. Aufgabe 6b
 */
void invTest() {
    cout << "inv() Test" << endl;
    cout << "==========" << endl << endl;
...
/**
 * Teste die Berechnung der parity Funktion. Aufgabe 7b
 */
void parityTest() {
...
/**
 * Teste die Berechnung der Linearen Transformation. Aufgabe 8b
 */
void atransTest() {
...
/**
 * Teste die Berechnung der rpmul und mul Funktionen. Aufgabe 5f
 */
void mulTest() {
    cout << "mult() Test" << endl;
    cout << "===========" << endl << endl;
...
//            cout << "a = " << AESMath::format(a) << ", b = " << AESMath::format(b) << ", mul = " << AESMath::format(m) << ", rpmul = " << AESMath::format(rpm) << endl;
            b++;
        }
        a++;
    }
...
/**
 * Teste die Berechnung der mul Funktion. Aufgabe 4b
 */
void mulTest2() {
...
/**
 * Teste die Berechnung der xtime Funktion. Aufgabe 3b
 */
void xtimeTest() {
...
/**
 * Teste die Berechnung des Generators
 */
void generator() {
    cout << "generator()" << endl;
    cout << "===========" << endl << endl;
...
/**
 * Teste die Berechnung der SBox und inversen SBox
 */
void sboxTest() {
    cout << endl;
    cout << "SBox Test():" << endl;
...
/**
 * Teste den State von AES nach einigen Operationen
 */
void stateTest() {
    cout << endl;
...
/**
 * Teste die Berechnung der Key Schedule (128 Bit).
 */
...
/**
 * Teste die Berechnung der Key Schedule (192 Bit).
 */
...
/**
 * Teste die Berechnung der Key Schedule (256 Bit).
 */
...
/**
 * Teste die Berechnung der Basisoperation mixColumns. Aufgabe 18c
 */
void mixColumnsTest() {
    cout << endl;
...
/**
 * Teste die Berechnung der Basisoperation shiftRows. Aufgabe 16c
 */
void shiftRowsTest() {
    cout << endl;
...
/**
 * Teste die Berechnung der Basisoperation subBytes. Aufgabe 17c
 */
void subBytesTest() {
    cout << endl;
...
/**
 * Teste die Ver- und Entschlüsselung eines byte-Arrays
 */
void aesTest() {
    cout << endl;
...
/**
 * Teste die Ver- und Entschlüsselung eines übergebenen Plaintextes
 */
void aesTest2() {
    cout << endl;
...
/**
 * Teste die Ver- und Entschlüsselung eines selbst gewählten Plaintextes. Aufgabe 24d
 */
void aufgabe24Test(){
    cout << endl;
    cout << "AESCipher Aufgabe 24 Encryption/Decryption Test:" << endl;
    cout << "====================" << endl << endl;
    ...
    string msg("Ein Test fuer die Aufgabe 24, mit einem selbstgewaehltem Byte-Array!");
    plain_text = AESCipher::toVector(msg);
    ...
    string encrypted_hex = AESCipher::toHexString(cipher_text);
    cout << "Verschlüsselt hex: " << encrypted_hex << endl;

    aes.process(cipher_text, plain_text, true);

    string msg2 = AESCipher::toString(plain_text);

    cout << "Entschlüsselt: " << msg2 << endl;
}
