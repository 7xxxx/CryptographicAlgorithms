/*
  ...
  /usr/bin/gengetopt --include-getopt --unamed-opts -i searchshift-getopt.ggo -F searchshift-getopt 
...
const char *gengetopt_args_info_purpose = "Command line options for the searchshift executable\n\nBy Prof. Dr. Christoph Karg <christoph.karg@hs-aalen.de>";

const char *gengetopt_args_info_usage = "Usage: searchshift [OPTION]... [FILE]...";
...
const char *gengetopt_args_info_help[] = {
  ...
  "  -c, --columns=INT      Number of columns to be analyzed.  (default=`6')",
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->columns_arg = 6;
  args_info->columns_orig = NULL;
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->columns_help = gengetopt_args_info_help[2] ;
...
{
  unsigned int i;
  free_string_field (&(args_info->columns_orig));
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->columns_given)
    write_into_file(outfile, "columns", args_info->columns_orig, 0);
...
cmdline_parser_required2 (struct gengetopt_args_info *args_info, const char *prog_name, const char *additional_error)
{
  ...
  if (! args_info->columns_given)
    {
      fprintf (stderr, "%s: '--columns' ('-c') option required%s\n", prog_name, (additional_error ? additional_error : ""));
      error_occurred = 1;
    }
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVc:t:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'c':	/* Number of columns to be analyzed..  */
        
        
          if (update_arg( (void *)&(args_info->columns_arg), 
               &(args_info->columns_orig), &(args_info->columns_given),
              &(local_args_info.columns_given), optarg, 0, "6", ARG_INT,
