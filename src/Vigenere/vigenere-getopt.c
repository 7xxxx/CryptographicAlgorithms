/*
  ...
  /usr/bin/gengetopt --include-getopt --unamed-opts -i vigenere-getopt.ggo -F vigenere-getopt 
...
const char *gengetopt_args_info_purpose = "Command line options for the vigenere executable\n\nBy Prof. Dr. Christoph Karg <christoph.karg@hs-aalen.de>";

const char *gengetopt_args_info_usage = "Usage: vigenere [OPTION]... [FILE]...";
...
const char *gengetopt_args_info_help[] = {
  ...
  "  -k, --key=STRING  Key to be used for encryption or decryption",
...
void clear_given (struct gengetopt_args_info *args_info)
{
  ...
  args_info->opmode_group_counter = 0 ;
}
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->key_help = gengetopt_args_info_help[2] ;
  args_info->out_help = gengetopt_args_info_help[3] ;
  args_info->encrypt_help = gengetopt_args_info_help[5] ;
  args_info->decrypt_help = gengetopt_args_info_help[6] ;
...
static void
reset_group_opmode(struct gengetopt_args_info *args_info)
{
  if (! args_info->opmode_group_counter)
    return;
...
cmdline_parser_required2 (struct gengetopt_args_info *args_info, const char *prog_name, const char *additional_error)
{
  ...
  if (args_info->opmode_group_counter == 0)
    {
      fprintf (stderr, "%s: %d options of group opmode were given. One is required%s.\n", prog_name, args_info->opmode_group_counter, (additional_error ? additional_error : ""));
      error_occurred = 1;
    }
                        ...
                        struct cmdline_parser_params *params, const char *additional_error)
{
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVk:o:ed", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'k':	/* Key to be used for encryption or decryption.  */
        ...
        case 'e':	/* Encryption.  */
          ...
          if (args_info->opmode_group_counter && override)
            reset_group_opmode (args_info);
          args_info->opmode_group_counter += 1;
  ...
  if (args_info->opmode_group_counter > 1)
    {
      fprintf (stderr, "%s: %d options of group opmode were given. One is required%s.\n", argv[0], args_info->opmode_group_counter, (additional_error ? additional_error : ""));
      error_occurred = 1;
    }
