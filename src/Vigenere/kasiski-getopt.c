/*
  ...
  /usr/bin/gengetopt --include-getopt --unamed-opts -i kasiski-getopt.ggo -F kasiski-getopt 
...
const char *gengetopt_args_info_purpose = "Command line options for the kasiski executable\n\nBy Prof. Dr. Christoph Karg <christoph.karg@hs-aalen.de>";

const char *gengetopt_args_info_usage = "Usage: kasiski [OPTION]... [FILE]...";
...
const char *gengetopt_args_info_help[] = {
  ...
  "  -l, --len=INT  Length of the ngrams to analyze  (default=`3')",
    0
};
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVl:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'l':	/* Length of the ngrams to analyze.  */
        
        
          if (update_arg( (void *)&(args_info->len_arg), 
               &(args_info->len_orig), &(args_info->len_given),
              &(local_args_info.len_given), optarg, 0, "3", ARG_INT,
