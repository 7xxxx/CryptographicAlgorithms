/*
  ...
  /usr/bin/gengetopt --include-getopt --unamed-opts -i coindex-getopt.ggo -F coindex-getopt 
...
const char *gengetopt_args_info_purpose = "Command line options for the coindex executable\n\nBy Prof. Dr. Christoph Karg <christoph.karg@hs-aalen.de>";

const char *gengetopt_args_info_usage = "Usage: coindex [OPTION]... [FILE]...";
...
const char *gengetopt_args_info_help[] = {
  ...
  "  -m, --max-columns=INT  Maximum number of columns to be analyzed.\n                           (default=`6')",
  "  -t, --threshold=FLOAT  Threshold  (default=`0.065')",
    0
};
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->max_columns_arg = 6;
  args_info->max_columns_orig = NULL;
  args_info->threshold_arg = 0.065;
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->max_columns_help = gengetopt_args_info_help[2] ;
...
{
  unsigned int i;
  free_string_field (&(args_info->max_columns_orig));
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->max_columns_given)
    write_into_file(outfile, "max-columns", args_info->max_columns_orig, 0);
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVm:t:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'm':	/* Maximum number of columns to be analyzed..  */
        
        
          if (update_arg( (void *)&(args_info->max_columns_arg), 
               &(args_info->max_columns_orig), &(args_info->max_columns_given),
              &(local_args_info.max_columns_given), optarg, 0, "6", ARG_INT,
        ...
        case 't':	/* Threshold.  */
          ...
          if (update_arg( (void *)&(args_info->threshold_arg), 
              ...
              &(local_args_info.threshold_given), optarg, 0, "0.065", ARG_FLOAT,
              check_ambiguity, override, 0, 0,
              "threshold", 't',
              additional_error))
            goto failure;
